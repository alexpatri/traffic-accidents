...
interpretabilidade**. Artefatos em `outputs/clustering/` (relatório, figuras e os Parquet
com os rótulos); código em `src/clustering/` (executar com `python -m src.clustering.main`).
...
investimento distintas. Figuras: `outputs/clustering/figures/trechos_pca.png`,
...
fazer**. Código em `src/priorizacao/` (`python -m src.priorizacao.main`); relatório completo,
figuras e a lista priorizada em `outputs/priorizacao/`.
...
![BRs: volume × letalidade](outputs/priorizacao/figures/br_volume_letalidade.png)
